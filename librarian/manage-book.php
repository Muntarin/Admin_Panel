                                    ...
                                    <form action="" method="post">
                                        <div class="form-group">
                                            <label for="book_name " >Book Name</label>
                                                ...
                                                <input type="hidden" name="id" class="form-control" required value="<?= $book_info_row['id'] ?>"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="book_publication_name">Publication Name</label>
                                                <input type="text" name="book_publication_name" class="form-control" id="book_publication_name" placeholder="Publication Name" required value="<?= $book_info_row['book_publication_name'] ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label for="book_author_name" >Author Name</label>
                                                <input type="text" name="book_author_name" class="form-control" id="book_author_name" placeholder="Author Name" required  value="<?= $book_info_row['book_author_name'] ?>"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="book_purchase_date" >Purchase Date</label>
                                                <input type="date" name="book_purchase_date" class="form-control" id="book_purchase_date" placeholder="Purchase Date" required value="<?= $book_info_row['book_purchase_date'] ?>" />
                                        </div>
                                        <div class="form-group">
...
if (isset($_POST['update-book'])){
    ...
    $result = mysqli_query($con,"UPDATE books SET book_name='$book_name',book_author_name='$book_author_name',book_publication_name='$book_publication_name',book_purchase_date='$book_purchase_date',book_price='$book_price',book_qty='$book_qty', available_qty='$available_qty',library_username='$library_username' WHERE id ='$id' ");
    if ($result){
        ?>
